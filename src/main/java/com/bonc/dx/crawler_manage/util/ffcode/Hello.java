package com.bonc.dx.crawler_manage.util.ffcode;
...
public class Hello {
    public static void main( String[] args) throws Exception {
        Api api = new Api();
        String app_id = "329097";
        String app_key = "PKuFbaiEobQJMbkfBy+FmA83jIu2bHds";
        String pd_id = "129097";
        String pd_key = "9GNOGDuE30Fmh0LpLieW8RvQtmZhyssQ";
...
//        resp = api.Predict(pred_type, GetUrlImage("http://htgs.ccgp.gov.cn/GS8/upload/verifyCodes/6f5c4b5f5b265375022ddb24fe122aec.jpg"));
//        System.out.printf("predict from file!ret: %d cust: %f err: %s reqid: %s pred: %s\n", resp.ret_code, resp.cust_val, resp.err_msg, resp.req_id, resp.pred_resl);
         String res2 = api.PredictExtend(pred_type, GetUrlImage("http://htgs.ccgp.gov.cn/GS8/upload/verifyCodes/7fabca47b44b56a5c888ab1711796f58.jpg")); // 直接返回识别结果
