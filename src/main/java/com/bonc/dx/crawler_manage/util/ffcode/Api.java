...
public class Api {
    ...
    public void Init2(){
        this.app_id     = System.getProperty("fateadmAppId");
        this.app_key    = System.getProperty("fateadmAppKey");
        this.pd_id     = System.getProperty("fateadmPd");
        this.pd_key    = System.getProperty("fateadmPdKey");
        this.pred_url   = "http://pred.fateadm.com";
    }
